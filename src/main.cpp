...
uint256 hashGenesisBlock("0xe92d32fbf0bff67a450c98510f2606cc5640e951d6c3db05c15b39f3077ed0b5");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1527459329, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("047b6c74047ee1fff217872f9b155cf02c2ced977aad8829d63ce30ae9d0599c978730944c1fece1f4032ea612a0eda0ef29684447ebc6a5a7c223d0ea69f27ac1") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1527459329;
        ...
        assert(block.hashMerkleRoot == uint256("0x2edd5d4df85e195a5c67198423f3c21fee899c0b53eee0e482e7243a54ab4500"));
...
unsigned char pchMessageStart[4] = { 0x36, 0x3e, 0x34, 0xda }; // Brlcoin: increase each by adding 2 to bitcoin's value.
